...
def generar_lista_geolocalizacion(request):
    if request.method == 'POST':
        try:
            ...
            # Definir la consulta SQL y ejecutarla
            sql = 'select * from generar_lista_geolocalizacion(%s,%s,%s)'
