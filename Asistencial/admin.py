...
class pacienteAdmin(admin.ModelAdmin):
    list_display = ('tipo_doc','num_doc','ape_pat','ape_mat','nombres','fecha_nac','sexo','hospital_id','medico_id','fecha_ultima_dialisis','estado','direccion','distrito','hospital_id','medico_id','fecha_ultima_dialisis')
    ordering = ['ape_pat',]
